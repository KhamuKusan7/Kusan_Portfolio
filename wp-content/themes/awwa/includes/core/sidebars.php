...
if ( ! function_exists( 'awwa_widget_init' ) ) {
	function awwa_widget_init() {
		if ( function_exists( 'register_sidebar' ) ) {

			// Main Widget Area
			register_sidebar(
				array(
					'name' => esc_html__( 'Main Widget Area', 'awwa' ),
					'id' => 'sidebar-1',
					'description' => esc_html__( 'Appears on posts and pages.', 'awwa' ),
	    ...
	    if( $footer_widgets ) {
	      ...
	      for( $i = 0; $i < $length; $i++ ) {
	        ...
	        register_sidebar( array(
	          'id'            => 'footer-' . $num,
	          'name'          => esc_html__( 'Footer Widget ', 'awwa' ). $num,
	          'description'   => esc_html__( 'Appears on footer section.', 'awwa' ),
	...
	add_action( 'widgets_init', 'awwa_widget_init' );
}