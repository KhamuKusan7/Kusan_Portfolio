 ...
 */
	...
	// Theme Options
	$awwa_single_comment = cs_get_option( 'single_comment_form' );
...
?>
<div class="wpo-blog-single-section section-padding <?php echo esc_attr( $awwa_content_padding .' '. $awwa_sidebar_class ); ?>" style="<?php echo esc_attr( $awwa_custom_padding ); ?>">
