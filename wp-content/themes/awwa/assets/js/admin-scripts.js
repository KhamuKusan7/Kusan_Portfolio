/*
 * All Admin Related Scripts in this Awwa Theme
...
"use strict";
  ...
  /*---------------------------------------------------------------*/
   function awwa_gutenberg_toggle_metaboxes() {
  ...
  function awwa_toggle_metaboxes() {
  ...
  $(document).ready(function() {
      awwa_gutenberg_toggle_metaboxes();
      awwa_toggle_metaboxes();
    $('#post-formats-select input[type="radio"]').on('click', awwa_toggle_metaboxes);
  });
