...
get_header();
	...
	// Theme Options
	$awwa_sidebar_position = cs_get_option( 'project_sidebar_position' );
	$awwa_single_comment = cs_get_option( 'project_comment_form' );
	$awwa_sidebar_position = $awwa_sidebar_position ? $awwa_sidebar_position : 'sidebar-hide';
	// Sidebar Position
	if ( $awwa_sidebar_position === 'sidebar-hide' ) {
		$awwa_layout_class = 'col-lg-12';
		$awwa_sidebar_class = 'hide-sidebar';
	} elseif ( $awwa_sidebar_position === 'sidebar-left' ) {
		$awwa_layout_class = 'col col-lg-8 order-lg-2';
		$awwa_sidebar_class = 'left-sidebar';
	} else {
		$awwa_layout_class = 'col col-lg-8';
		$awwa_sidebar_class = 'right-sidebar';
	} ?>
<div class="project-single-section section-padding <?php echo esc_attr( $awwa_content_padding .' '. $awwa_sidebar_class ); ?>" style="<?php echo esc_attr( $awwa_custom_padding ); ?>">
	<div class="container">
		<div class="row">
