...
(function ($) {
   ...
   ==========================================================================*/
    ...
    -------------------------------------------*/
        ...
        //hero_slider
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_hero.default', function ($scope, $) {
            hero_slider();
        });
        ...
        //rotate_text
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_about.default', function ($scope, $) {
            rotate_text();
        });
        // projectSlide
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_project.default', function ($scope, $) {
            projectSlide();
        });
        //project_slider
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_project.default', function ($scope, $) {
        ...
        //Gallery_slider
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_gallery.default', function ($scope, $) {
            gallery_slider();
        });
        ...
        //Slider
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_slider.default', function ($scope, $) {
            swiper_slide();
        });
        ...
        //testimonial
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_testimonial.default', function ($scope, $) {
            testimonials_slider();
        });
        //Project Single
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_gallery.default', function ($scope, $) {
        ...
        //odometer
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_funfact.default', function ($scope, $) {
            odometer();
        });

        //partners_slider
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_client.default', function ($scope, $) {
            partners_slider();
        });

        //event_date
        elementorFrontend.hooks.addAction('frontend/element_ready/wpo-awwa_event.default', function ($scope, $) {
            event_date();
        });
