<?php
/* Spacer */
function awwa_spacer_function($atts, $content = true) {
...
add_shortcode("awwa_spacer", "awwa_spacer_function");

/* Social Icons */
function awwa_socials_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "social_select" => '',
    "custom_class" => '',
    "section_title" => '',
  ...
  if ( $icon_color || $icon_size ) {
    ...
    $inline_style .= ( $icon_size ) ? 'font-size:'. awwa_core_check_px($icon_size) .';' : '';
    $inline_style .= '}';
  }
...
add_shortcode("awwa_socials", "awwa_socials_function");

/* Social Icon */
function awwa_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_link" => '',
      "social_icon" => '',
      "target_tab" => ''
...
add_shortcode("awwa_social", "awwa_social_function");



/* Simple Images */
function awwa_image_lists_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "custom_class" => '',
  ), $atts));
...
add_shortcode("awwa_image_lists", "awwa_image_lists_function");

/* Simple Image */
function awwa_image_list_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "get_image" => '',
    "link" => '',
    "open_tab" => ''
...
add_shortcode("awwa_image_list", "awwa_image_list_function");

/* Simple Underline Link */
function awwa_simple_link_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "link_style" => '',
    "link_icon" => '',
    "link_text" => '',
  ...
  if ( $text_color || $text_size ) {
    ...
    $inline_style .= ( $text_size ) ? 'font-size:'. awwa_core_check_px($text_size) .';' : '';
    $inline_style .= '}';
  }
  if ( $text_hover_color ) {
...
add_shortcode("awwa_simple_link", "awwa_simple_link_function");


/* Top bar info */
function awwa_widget_topbars_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("awwa_widget_topbars", "awwa_widget_topbars_functions");

/* Top bar info */
function awwa_widget_topbar_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info_icon" => '',
      "subtitle" => '',
      "title" => '',
...
add_shortcode("awwa_widget_topbar", "awwa_widget_topbar_function");


/*header Social */
function awwa_header_socials_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "custom_text" => ''
   ), $atts));
...
add_shortcode("awwa_header_socials", "awwa_header_socials_function");

/* Address Info */
function awwa_header_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "social_link" => '',
...
add_shortcode("awwa_header_social", "awwa_header_social_function");


/*header Middle Info */
function awwa_header_middle_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("awwa_header_middle_infos", "awwa_header_middle_infos_function");

/*header Middle Info  */
function awwa_header_middle_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "address_text" => '',
...
add_shortcode("awwa_header_middle_info", "awwa_header_middle_info_function");
/*header Middle Info End */

/* Address Infos */
function awwa_address_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("awwa_address_infos", "awwa_address_infos_function");

/* Address Info */
function awwa_address_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "address_style" => '',
      "info_icon" => '',
      "info_icon_color" => '',
...
add_shortcode("awwa_address_info", "awwa_address_info_function");

/* Useful Links */
function awwa_useful_links_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "column_width" => '',
      "custom_class" => ''
   ), $atts));
...
add_shortcode("awwa_useful_links", "awwa_useful_links_function");

/* Useful Link */
function awwa_useful_link_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "target_tab" => '',
      "title_link" => '',
      "link_title" => ''
...
add_shortcode("awwa_useful_link", "awwa_useful_link_function");

/* Footer Menus */
function awwa_footer_menus_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("awwa_footer_menus", "awwa_footer_menus_function");

/* Footer Menu */
function awwa_footer_menu_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "menu_title" => '',
      "menu_link" => '',
      "target_tab" => ''
...
add_shortcode("awwa_footer_menu", "awwa_footer_menu_function");

/* footer contact */
function awwa_footer_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("awwa_footer_contact_infos", "awwa_footer_contacts_functions");

/*  footer contact  */
function awwa_footer_contacts_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "icon" => '',
      "item_title" => '',
   ), $atts));
...
add_shortcode("awwa_footer_contact_info", "awwa_footer_contacts_function");


 /* footer Address */
function awwa_addresss_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("awwa_footer_address_item", "awwa_addresss_functions");


 /* footer Addresss */
function awwa_address_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "item" => '',
   ), $atts));
...
add_shortcode("awwa_footer_address_items", "awwa_address_functions");

/* Blockquote */
function awwa_blockquote_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "blockquote_style" => '',
    "text_size" => '',
    "custom_class" => '',
...
add_shortcode("awwa_blockquote", "awwa_blockquote_function");


/* Footer Logo Items */
function awwa_widget_footer_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "footer_logo" => '',
      "desc" => '',
...
add_shortcode("footer_infos", "awwa_widget_footer_infos_functions");


/* Footer Logo Item */
function awwa_widget_footer_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_link" => '',
   ), $atts));
...
add_shortcode("footer_info", "awwa_widget_footer_infos_function");


/* Contact Infos */
function awwa_widget_contact_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "heading_title" => ''
   ), $atts));
...
add_shortcode("awwa_widget_contact_infos", "awwa_widget_contact_infos_functions");


/* Widget Contact Info */
function awwa_widget_contact_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "number" => '',
...
add_shortcode("awwa_widget_contact_info", "awwa_widget_contact_infos_function");


/* Widget Contact Info */
function awwa_widget_testimonial_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "subtitle" => '',
...
add_shortcode("awwa_widget_testimonial", "awwa_widget_testimonial_function");


/* Service Contact Widgets */
function awwa_service_widget_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("awwa_service_widget_contacts", "awwa_service_widget_contacts_functions");

/* Service Contact Widget */
function awwa_service_widget_contact_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info" => '',
   ), $atts));
...
add_shortcode("awwa_service_widget_contact", "awwa_service_widget_contact_functions");

/* Download Widgets */
function awwa_download_widgets_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("awwa_download_widgets", "awwa_download_widgets_functions");

/* Download Widget */
function awwa_download_widget_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "download_icon" => '',
      "title" => '',
      "link" => '',
...
add_shortcode("awwa_download_widget", "awwa_download_widget_functions");

/* Current Year - Shortcode */
if( ! function_exists( 'awwa_current_year' ) ) {
  function awwa_current_year() {
    return date('Y');
  }
  add_shortcode( 'awwa_current_year', 'awwa_current_year' );
}

/* Get Home Page URL - Via Shortcode */
if( ! function_exists( 'awwa_home_url' ) ) {
  function awwa_home_url() {
    return esc_url( home_url( '/' ) );
  }
  add_shortcode( 'awwa_home_url', 'awwa_home_url' );
}


/* About Widget */
function awwa_widget_about_block_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "image_url" => '',
   ...
   $result = '<div class="about-widget  '.esc_attr( $custom_class ).'"><div class="img-holder"><img src="'.esc_url( $image_url ).'" alt="'.esc_attr( $image_alt ).' "></div><h4>'.esc_html( $title ).'</h4><p>'.esc_html( $desc ).'</p><a class="theme-btn" href="'.esc_url( $link ).'">'.esc_html( $link_text ).'</a></div>';
   return $result;

}
add_shortcode("awwa_about_widget", "awwa_widget_about_block_function");