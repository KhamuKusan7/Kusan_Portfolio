 ...
 */
class awwa_causes_posts extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-causes-blog',
      AWWA_THEME_NAME_PLUGIN . esc_html__( ': Causes Posts', 'awwa' ),
      array(
        'classname'   => 'recent-post-widget',
        'description' => AWWA_THEME_NAME_PLUGIN . esc_html__( ' widget that displays causes posts.', 'awwa' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $instance   = wp_parse_args( $instance, array(
      'title'    => esc_html__( 'Causes Posts', 'awwa' ),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
...
add_action( 'widgets_init', function() { register_widget( "awwa_causes_posts" ); } );