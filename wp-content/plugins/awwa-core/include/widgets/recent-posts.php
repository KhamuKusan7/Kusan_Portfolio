 ...
 */
class awwa_recent_posts extends WP_Widget
{
  ...
  public function __construct()
  {
    parent::__construct(
      '-recent-blog',
      AWWA_THEME_NAME_PLUGIN . esc_html__(': Recent Posts', 'awwa'),
      array(
        'classname'   => 'recent-post-widget',
        'description' => AWWA_THEME_NAME_PLUGIN . esc_html__(' widget that displays recent posts.', 'awwa')
      )
    );
  }
  ...
  public function form($instance)
  {
    ...
    $instance   = wp_parse_args($instance, array(
      'title'    => esc_html__('Recent Posts', 'awwa'),
      'ptypes'   => 'post',
      'limit'    => '3',
      'date'     => true,
      'category' => '',
...
add_action('widgets_init', function () {
  register_widget("awwa_recent_posts");
});
