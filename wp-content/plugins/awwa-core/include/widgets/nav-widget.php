...
class awwa_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      '-navigation-widget',
      AWWA_THEME_NAME_PLUGIN . esc_html__( ': Navigation', 'awwa' ),
      array(
        'classname'   => 'link-widget',
        'description' => AWWA_THEME_NAME_PLUGIN . esc_html__( ' widget that displays navigations list.', 'awwa' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => esc_html__( 'Select Menu List :', 'awwa' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => esc_html__( 'Display Menu Children :', 'awwa' ),
      'help' => esc_html__( 'This only shows first level of child menus.', 'awwa' ),
    );
...
add_action( 'widgets_init', function() { register_widget( "awwa_navigation_widget" ); } );
