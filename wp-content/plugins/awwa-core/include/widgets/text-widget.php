 ...
 */
class awwa_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'text-widget',
      AWWA_THEME_NAME_PLUGIN . esc_html__( ': Text Widget', 'awwa' ),
      array(
        'classname'   => 'text-widget',
        'description' => AWWA_THEME_NAME_PLUGIN . esc_html__( ' widget that displays contents.', 'awwa' )
      )
    );
  }
...
add_action( 'widgets_init', function() { register_widget( "awwa_text_widget" ); } );