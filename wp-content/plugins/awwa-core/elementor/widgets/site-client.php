...
class Site_Client extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Client', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa Client widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Client widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_client',
			[
				'label' => esc_html__( 'Client Options', 'awwa-core' ),
			]
		);
		$this->add_control(
			'client_style',
			[
				'label' => esc_html__( 'Client Style', 'awwa-core' ),
				...
				'default' => 'style-one',
				'description' => esc_html__( 'Select your Client style.', 'awwa-core' ),
			]
		);
		$this->add_control(
			'section_title',
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => __( 'https://your-link.com', 'awwa-core' ),
				'label_block' => true,
				'show_external' => true,
				'default' => [
					'url' => '',
		...
		$this->add_control(
			'clientLogos_groups',
			[
				'label' => esc_html__( 'Client Logos', 'awwa-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'client_title' => esc_html__( 'Client', 'awwa-core' ),
					],
