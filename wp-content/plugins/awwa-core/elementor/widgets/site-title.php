...
class Awwa_Title extends Widget_Base
{
	...
	{
		return esc_html__('Title', 'awwa-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Awwa Title widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Title widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_Title',
			[
				'label' => esc_html__('Title Options', 'awwa-core'),
			]
		);
		$this->add_control(
			'title_style',
			[
				'label' => esc_html__('Title Style', 'awwa-core'),
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors' => [
					'{{WRAPPER}} .wpo-section-title, .wpo-section-title-s3' => 'max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
...
Plugin::instance()->widgets_manager->register(new Awwa_Title());
