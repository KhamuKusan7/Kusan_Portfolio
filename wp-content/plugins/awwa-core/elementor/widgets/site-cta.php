...
class Site_CTA extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'CTA', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa CTA widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa CTA widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_CTA',
			[
				'label' => esc_html__( 'CTA Options', 'awwa-core' ),
			]
		);
		$this->add_control(
			'cta_style',
			[
				'label' => esc_html__('CTA Style', 'awwa-core'),
		...
		$this->add_control(
			'subtitle_shape',
			[
				'label' => esc_html__( 'Subtitle Image', 'awwa-core' ),
		...
		$this->add_control(
			'cta_image',
			[
				'label' => esc_html__( 'CTA Image', 'awwa-core' ),
				'type' => Controls_Manager::MEDIA,
				'frontend_available' => true,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
		...
		$this->add_control(
			'shape_left',
			[
				'label' => esc_html__( 'Left Image', 'awwa-core' ),
				'type' => Controls_Manager::MEDIA,
				'condition' => [
		...
		$this->add_control(
			'shape_right',
			[
				'label' => esc_html__( 'Right Image', 'awwa-core' ),
				'type' => Controls_Manager::MEDIA,
				'condition' => [
					'cta_style' => array('style-two'),
				],
		...
		$this->add_group_control(
			...
			[
				...
				'types' => ['gradient'],
				'exclude' => ['image'],
				'selector' => '{{WRAPPER}} .awwa-cta .bg-overlay:before',
				'fields_options' => [
					'background' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}  .awwa-cta .cta-wrap span',
			]
		);
		$this->add_control(
			'subtitle_color',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .awwa-cta .cta-wrap span' => 'color: {{VALUE}};',
				],
			]
		);	
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .awwa-cta .cta-wrap span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();// end: Section
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}  .awwa-cta .cta-wrap h2',
			]
		);
		$this->add_control(
			'title_color',
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .awwa-cta .cta-wrap h2' => 'color: {{VALUE}};',
				],
			]
		);	
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .awwa-cta .cta-wrap h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();// end: Section
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .awwa-cta .theme-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->start_controls_tabs( 'button_style' );
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .awwa-cta .theme-btn, 
						{{WRAPPER}} .awwa-cta .theme-btn' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'types' => ['gradient'],
					'exclude' => ['image'],
					'selector' => '{{WRAPPER}} .awwa-cta .theme-btn:after',
					'fields_options' => [
						'background' => [
							'label' => esc_html__('Background Color', 'awwa-core'),
							'default' => 'gradient',
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .awwa-cta .theme-btn',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .awwa-cta .theme-btn:hover,
						{{WRAPPER}} .awwa-cta .theme-btn:hover' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'types' => ['gradient'],
					'exclude' => ['image'],
					'selector' => '{{WRAPPER}} .awwa-cta .theme-btn:hover',
					'fields_options' => [
						'background' => [
							'label' => esc_html__('Background Color', 'awwa-core'),
							'default' => 'gradient',
	...
	*/
	protected function render() {
		...
		<div class="awwa-cta wpo-cta-section" <?php echo $bg_url; ?>>
		    <div class="shape-1">
