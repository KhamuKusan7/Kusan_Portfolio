...
class Awwa_Navmenu extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Nav Menu', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa Navmenu widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Navmenu widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_Navmenu',
			[
				'label' => esc_html__( 'Navmenu Options', 'awwa-core' ),
			]
		);
...
Plugin::instance()->widgets_manager->register( new Awwa_Navmenu() );