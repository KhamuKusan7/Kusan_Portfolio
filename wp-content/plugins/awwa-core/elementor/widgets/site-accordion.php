<?php
/*
 * Elementor Awwa Accordion  Widget
...
class Awwa_Accordion  extends Widget_Base
{
	...
	{
		return esc_html__('Accordion ', 'awwa-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Awwa Accordion  widget depended on.
	...
	/**
	 * Register Awwa Accordion  widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_accordion',
			[
				'label' => esc_html__('Accordion  Options', 'awwa-core'),
			]
		);
		...
		$repeater->add_control(
			'active_tabs',
			[
				'label' => __('Active Accordion', 'awwa-core'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'awwa-core'),
				'label_off' => __('Hide', 'awwa-core'),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Accordion  Items', 'awwa-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'accordion_title' => esc_html__('Accordion ', 'awwa-core'),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Accordion Content', 'awwa-core'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
			...
			[
				'label' => esc_html__('Typography', 'awwa-core'),
				'name' => 'awwa_accordion_content_typography',
...
Plugin::instance()->widgets_manager->register(new Awwa_Accordion());
