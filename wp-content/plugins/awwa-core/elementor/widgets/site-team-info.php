<?php
/*
 * Elementor awwa Team Info Widget
...
class Site_TeamInfo extends Widget_Base
{
	...
	{
		return esc_html__('Team Info', 'awwa-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_TeamInfo',
			[
				'label' => esc_html__('Team Info Options', 'awwa-core'),
			]
		);
		$this->add_control(
			'section_title',
		...
		$this->add_control(
			'certificate_gallery',
			[
				'label' => esc_html__('Add Images', 'awwa-core'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Team Info', 'awwa-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'single_team_title' => esc_html__('Team Info', 'awwa-core'),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Info', 'awwa-core'),
