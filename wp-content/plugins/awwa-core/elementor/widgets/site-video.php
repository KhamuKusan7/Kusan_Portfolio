...
class Site_Video extends Widget_Base
{
	...
	{
		return esc_html__('Video', 'awwa-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Awwa Video widget depended on.
	...
	/**
	 * Register Awwa Video widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_video',
			[
				'label' => esc_html__('Video Options', 'awwa-core'),
			]
		);
		...
		$this->add_control(
			'video_image',
			[
				'label' => esc_html__('Video Image', 'awwa-core'),
		...
		$this->start_controls_section(
			'section_video_style',
			[
				'label' => esc_html__('Video Button', 'awwa-core'),
		...
		$this->add_control(
			'video_button_color',
			[
				'label' => esc_html__('button Color', 'awwa-core'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_shape_style',
			[
				'label' => esc_html__('Shape Style', 'awwa-core'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'shape1_color',
			[
				'label' => esc_html__('Shape1 Bg', 'awwa-core'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'shape2_color',
			[
				'label' => esc_html__('Shape2 Bg', 'awwa-core'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'shape3_color',
			[
				'label' => esc_html__('Shape3 Bg', 'awwa-core'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'shape4_color',
			[
				'label' => esc_html__('Shape4 Bg', 'awwa-core'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
