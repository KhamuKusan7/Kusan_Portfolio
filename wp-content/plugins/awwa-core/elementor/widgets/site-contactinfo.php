...
class Awwa_Contactinfo extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-awwa_contactinfo';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Contact Info', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa Contactinfo widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Contactinfo widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_contactinfo',
			[
				'label' => esc_html__( 'Contactinfo Options', 'awwa-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( '24/7 customer support.', 'awwa-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Contactinfo Icons', 'awwa-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'contactinfo_title' => esc_html__( 'Contactinfo', 'awwa-core' ),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Info Box', 'awwa-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon BG', 'awwa-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
	...
	// Content
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Active', 'awwa-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'active_bg_color',
			[
				'label' => esc_html__( 'Active Background', 'awwa-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'active_border_color',
			[
				'label' => esc_html__( 'Active Border', 'awwa-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'active_color',
			[
				'label' => esc_html__( 'Text Color', 'awwa-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Awwa_Contactinfo() );