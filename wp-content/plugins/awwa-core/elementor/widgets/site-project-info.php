<?php
/*
 * Elementor awwa ProjectItem Widget
...
class Site_ProjectItem extends Widget_Base{
	...
	*/
	public function get_title(){
		return esc_html__( 'Project Info', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the awwa ProjectItem widget depended on.
	...
	*/
	...
	/**
	 * Register awwa ProjectItem widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_ProjectItem',
			[
				'label' => esc_html__( 'ProjectItem Options', 'awwa-core' ),
			]
		);
		$this->add_control(
			'section_title',
