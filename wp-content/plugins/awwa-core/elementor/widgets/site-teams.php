...
class Awwa_Teams extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-awwa_teams';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Team Single', 'awwa-core' );
	}
    ...
    if ( $posts ) {
      ...
      $PostID[ __( 'No ID\'s found', 'awwa' ) ] = 0;
		...
		$this->add_control(
			'team_limit',
			[
				'label' => esc_html__( 'Team Limit', 'awwa-core' ),
    ...
    if ($team_show_id) {
      ...
      'post__in' => $team_show_id,
        ...
        <div class="volunteer-wraper">
            <div class="row">
	            	<?php 
									if ( $awwa_team->have_posts()) : while ( $awwa_team->have_posts()) : $awwa_team->the_post();
...
Plugin::instance()->widgets_manager->register( new Awwa_Teams() );