...
class Awwa_brand extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-awwa_brand';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Site Logo', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa brand widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa brand widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_brand',
			[
				'label' => esc_html__( 'Brand Options', 'awwa-core' ),
			]
		);
		$this->add_control(
			'brand_logo',
			[
				'label' => esc_html__( 'Site Logo', 'awwa-core' ),
...
Plugin::instance()->widgets_manager->register( new Awwa_brand() );