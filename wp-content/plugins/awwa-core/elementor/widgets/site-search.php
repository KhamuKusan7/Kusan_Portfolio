...
class Awwa_Search extends Widget_Base{
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa Search widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Search widget controls.
...
Plugin::instance()->widgets_manager->register( new Awwa_Search() );