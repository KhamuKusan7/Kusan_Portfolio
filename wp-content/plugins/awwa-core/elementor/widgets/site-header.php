...
class Site_Header extends Widget_Base
{
	...
	{
		return esc_html__('Header', 'awwa-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Awwa Header widget depended on.
	...
	/**
	 * Register Awwa Header widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_Header',
			[
				'label' => esc_html__('Header Options', 'awwa-core'),
			]
		);
		$this->add_control(
			'navigation_style',
			[
				...
				'default' => 'style-one',
				'description' => esc_html__('Select your navigation style.', 'awwa-core'),
			]
		);
		...
		if (!empty($menus)) {
			$this->add_control(
				...
				[
					...
					'save_default' => true,
					'separator' => 'after',
					'description' => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'awwa'), admin_url('nav-menus.php')),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __('There are no menus in your site.', 'awwa') . '</strong><br>' . sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'awwa'), admin_url('nav-menus.php?action=edit&menu=0')),
					'separator' => 'after',
					'content_classes' => 'awwa-panel-alert awwa-panel-alert-info',
				]
			);
		}
		$this->add_control(
			'header_logo',
			[
				'label' => esc_html__('Logo Image', 'awwa-core'),
		...
		$this->add_control(
			'btn_text',
			[
				'label' => esc_html__('Button/Link Text', 'awwa-core'),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__('Button Text', 'awwa-core'),
				'placeholder' => esc_html__('Type btn text here', 'awwa-core'),
				'label_block' => true,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'header_search',
			[
				'label' => esc_html__('Search', 'awwa-core'),
		...
		$this->add_control(
			'header_cart',
			[
				'label' => esc_html__('Cart', 'awwa-core'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Show', 'awwa-core'),
				'label_off' => esc_html__('Hide', 'awwa-core'),
				'return_value' => 'true',
		...
		$this->start_controls_section(
			'awwa_section_style_main-menu',
			[
				'label' => __('Main Menu', 'awwa'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Main Menu Height', 'awwa'),
		...
		$this->start_controls_tab(
			'awwa_tab_menu_item_normal',
			[
				'label' => __('Normal', 'awwa'),
			]
		);

		$this->add_control(
			'awwa_color_menu_bg_item',
			[
				'label' => __('Background Color', 'awwa'),
		...
		$this->add_control(
			'awwa_color_menu_item',
			[
				'label' => __('Text Color', 'awwa'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Horizontal Padding', 'awwa'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Vertical Padding', 'awwa'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			...
			[
				'raw' => __('On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'awwa'),
				'type' => Controls_Manager::RAW_HTML,
				'content_classes' => 'awwa-descriptor',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Search & Cart', 'awwa-core'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Icon Color', 'awwa-core'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render()
	{
		...
		if ($navigation_style == 'style-one') {
			...
			$nav_style = 'wpo-header-style-2';
			$logo_col = 'col-lg-2';
			$header_container = 'container-fluid';
			$header_right_col = 'col-lg-3';
		} else {
			$nav_style = 'wpo-header-style-3';
			$logo_col = 'col-lg-2';
			$header_container = 'container-fluid';
			$header_right_col = 'col-lg-3';
		}
									...
									<div class="mini-cart">
										...
										<div class="mini-cart-content">
											...
											<div class="mini-cart-title">
												<p><?php echo esc_html__('Shopping Cart', 'awwa'); ?></p>
											</div>
