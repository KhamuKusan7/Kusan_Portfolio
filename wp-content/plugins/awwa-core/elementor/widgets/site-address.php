...
class Awwa_Address extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-awwa_address';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Address Info', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa Address widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Address widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_address',
			[
				'label' => esc_html__( 'Address Options', 'awwa-core' ),
			]
		);
		$this->add_control(
			'address_desc',
			[
				'label' => esc_html__( 'Address Text', 'awwa-core' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Call: +88 659 789 874', 'awwa-core' ),
				'placeholder' => esc_html__( 'Type title text here', 'awwa-core' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			'addressItems_groups',
			[
				'label' => esc_html__( 'Address', 'awwa-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'address_title' => esc_html__( 'Address', 'awwa-core' ),
					],
...
Plugin::instance()->widgets_manager->register_widget_type( new Awwa_Address() );