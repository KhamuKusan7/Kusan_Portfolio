...
class Awwa_Product extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-awwa_product';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Product', 'awwa-core' );
	}
  ...
  public function get_keywords() {
	...
	/**
	 * Retrieve the list of scripts the Awwa Product widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Product widget controls.
    ...
    if ( $posts ) {
      ...
      $PostID[ __( 'No ID\'s found', 'awwa' ) ] = 0;
		...
		$this->add_control(
			'product_limit',
			[
				'label' => esc_html__( 'Product Limit', 'awwa-core' ),
...
Plugin::instance()->widgets_manager->register( new Awwa_Product() );