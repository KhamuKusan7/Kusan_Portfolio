<?php
/*
 * Elementor Awwa ServiceItem Widget
...
class Site_ServiceItem extends Widget_Base
{
	...
	{
		return esc_html__('Service Feature', 'awwa-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Awwa ServiceItem widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa ServiceItem widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_ServiceItem',
			[
				'label' => esc_html__('ServiceItem Options', 'awwa-core'),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Feature Icons', 'awwa-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'single_feature_title' => esc_html__('Feature', 'awwa-core'),
					],
