...
class Awwa_Prayer extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-awwa_prayer';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Prayer Time', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa Prayer widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Prayer widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_prayer',
			[
				'label' => esc_html__( 'Prayer Options', 'awwa-core' ),
			]
		);
		$this->add_control(
			'prayer_style',
			[
				'label' => esc_html__('Prayer Style', 'awwa-core'),
				...
				'default' => 'style-one',
				'description' => esc_html__('Select your Prayer style.', 'awwa-core'),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Fajar', 'awwa-core' ),
		...
		$repeater->add_control(
			'prayer_subtitle',
			[
				'label' => esc_html__( 'SubTitle Text', 'awwa-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( '5:10 am', 'awwa-core' ),
				'placeholder' => esc_html__( 'Type title text here', 'awwa-core' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			'prayerItems_groups',
			[
				'label' => esc_html__( 'Prayer', 'awwa-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'prayer_title' => esc_html__( 'Prayer', 'awwa-core' ),
					],
		...
		$this->start_controls_section(
			'section_body_style',
			[
				'label' => esc_html__( 'Body', 'awwa-core' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .awwa-prayer .prayertine-wrap, .prayertine-section-s3' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .awwa-prayer' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();// end: Section
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .awwa-prayer h2',
			]
		);
		$this->add_control(
			'title_color',
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .awwa-prayer h2' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .awwa-prayer h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();// end: Section
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sub Title', 'awwa-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .awwa-prayer span',
			]
		);
		$this->add_control(
			'subtitle_color',
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .awwa-prayer span' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .awwa-prayer span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();// end: Section
	...
	*/
	protected function render() {
		...
		ob_start(); ?>
		<div class="awwa-prayer <?php echo esc_attr( $prayer_wrap ); ?>">
	    <div class="container">
...
Plugin::instance()->widgets_manager->register_widget_type( new Awwa_Prayer() );