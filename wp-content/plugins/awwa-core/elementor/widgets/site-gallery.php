...
class Site_Gallery extends Widget_Base
{
	...
	{
		return esc_html__('Gallery', 'awwa-core');
	}
	...
	/**
	 * Retrieve the list of scripts the Awwa Gallery widget depended on.
	...
	/**
	 * Register Awwa Gallery widget controls.
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_gallery',
			[
				'label' => esc_html__('Gallery Options', 'awwa-core'),
			]
		);
		...
		$repeater->add_control(
			'gallery_image',
			[
				'label' => esc_html__('Gallery Image', 'awwa-core'),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__('Title', 'awwa-core'),
				'placeholder' => esc_html__('Type Title here', 'awwa-core'),
				'label_block' => true,
			]
		);
		$this->add_control(
			'galleryItems_groups',
			[
				'label' => esc_html__('Gallery Items', 'awwa-core'),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'gallery_title' => esc_html__('Gallery', 'awwa-core'),
					],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Overly', 'awwa-core'),
		...
		$this->add_control(
			'overly_color',
			[
				'label' => esc_html__('Overly Color', 'awwa-core'),
		...
		$this->start_controls_section(
			'gallery_icon_style',
			[
				'label' => esc_html__('Icon', 'awwa-core'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="portfolio-grids gallery-container clearfix gallery-slide">
							...
							?>
									<div class="grid s<?php echo esc_html($uniqueID); ?>">
