...
class Awwa_Team extends Widget_Base{

	/**
	 * Retrieve the widget name.
	*/
	public function get_name(){
		return 'wpo-awwa_team';
	}
	...
	*/
	public function get_title(){
		return esc_html__( 'Team', 'awwa-core' );
	}
	...
	*/
	...
	/**
	 * Retrieve the list of scripts the Awwa Team widget depended on.
	...
	*/
	...
	/**
	 * Register Awwa Team widget controls.
	...
	*/
	protected function register_controls(){
		...
		$this->start_controls_section(
			'section_team',
			[
				'label' => esc_html__( 'Team Options', 'awwa-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Sub Title Text', 'awwa-core' ),
				'placeholder' => esc_html__( 'Type sub title text here', 'awwa-core' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
			'bg_image',
			[
				'label' => esc_html__( 'Team Image', 'awwa-core' ),
		...
		$this->add_control(
			'teamItems_groups',
			[
				'label' => esc_html__( 'Team Items', 'awwa-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'team_title' => esc_html__( 'Team', 'awwa-core' ),
					],
		...
		$this->add_group_control(
			...
			[
				...
				'name' => 'team_awwa_title_typography',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Subtitle Padding', 'awwa-core' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
...
Plugin::instance()->widgets_manager->register( new Awwa_Team() );